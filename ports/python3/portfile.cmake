...
if(VCPKG_TARGET_IS_WINDOWS)
    ...
    if(NOT VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_OSX)
        foreach(PROGRAM autoconf automake libtool pkg-config)
            find_program(${PROGRAM}_FOUND ${PROGRAM})
            if(NOT ${PROGRAM}_FOUND)
                message(FATAL_ERROR "Could not find ${PROGRAM}. Please install it through your system's package manager.")
            endif()
        endforeach()
    endif()
